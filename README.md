...
| Item | Description |
| --- | --- |
| [Scripts/BlockAgents/Block-AllCopilotAgents.ps1](Scripts/BlockAgents/Block-AllCopilotAgents.ps1) | PowerShell 7 script blocks agents that are not in the supplied allowlist via a beta Graph API endpoint. It skips agents that are already blocked and reports blocked, protected, draft/unpublished, and failed agents. |
| [Scripts/BlockAgents/allowedAgents.json](Scripts/BlockAgents/allowedAgents.json) | Example allowlist file used by the blocking script. Provides the structure required by the Block-AllCopilotAgents.ps1 script. |
